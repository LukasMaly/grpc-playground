...
class ImageProcessingStreamStub(object):
  # missing associated documentation comment in .proto file
  pass
  ...
  def __init__(self, channel):
    ...
    self.ToGrayscale = channel.stream_stream(
        '/imageprocessing.ImageProcessingStream/ToGrayscale',
        request_serializer=imageprocessing__pb2.Image.SerializeToString,
        response_deserializer=imageprocessing__pb2.Image.FromString,
        )


class ImageProcessingStreamServicer(object):
  # missing associated documentation comment in .proto file
  pass
...
def add_ImageProcessingStreamServicer_to_server(servicer, server):
  rpc_method_handlers = {
  ...
  generic_handler = grpc.method_handlers_generic_handler(
      'imageprocessing.ImageProcessingStream', rpc_method_handlers)
  server.add_generic_rpc_handlers((generic_handler,))
